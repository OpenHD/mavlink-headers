...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_LEN 26
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_MIN_LEN 26
#define MAVLINK_MSG_ID_1212_LEN 26
#define MAVLINK_MSG_ID_1212_MIN_LEN 26

#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_CRC 117
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_CARD { \
    ...
    {  { "card_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_index) }, \
         ...
         { "dummy0", NULL, MAVLINK_TYPE_INT8_T, 0, 25, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy0) }, \
...
static inline uint16_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t card_index, uint8_t card_type, int8_t rx_rssi_1, int8_t rx_rssi_2, int16_t tx_power, uint32_t count_p_received, uint32_t count_p_injected, int8_t curr_rx_packet_loss_perc, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_send(mavlink_channel_t chan, uint8_t card_index, uint8_t card_type, int8_t rx_rssi_1, int8_t rx_rssi_2, int16_t tx_power, uint32_t count_p_received, uint32_t count_p_injected, int8_t curr_rx_packet_loss_perc, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_LEN];
    _mav_put_uint32_t(buf, 0, count_p_received);
 ...
 */
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t card_index, uint8_t card_type, int8_t rx_rssi_1, int8_t rx_rssi_2, int16_t tx_power, uint32_t count_p_received, uint32_t count_p_injected, int8_t curr_rx_packet_loss_perc, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
