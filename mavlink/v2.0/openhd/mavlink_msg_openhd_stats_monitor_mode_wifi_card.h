...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_CRC 123
#define MAVLINK_MSG_ID_1212_CRC 123
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_CARD { \
    ...
    23, \
    {  { "card_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 18, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_index) }, \
         { "card_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 19, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_type) }, \
         { "tx_active", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, tx_active) }, \
         { "rx_rssi", NULL, MAVLINK_TYPE_INT8_T, 0, 21, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_rssi) }, \
         { "rx_rssi_1", NULL, MAVLINK_TYPE_INT8_T, 0, 22, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_rssi_1) }, \
         { "rx_rssi_2", NULL, MAVLINK_TYPE_INT8_T, 0, 23, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_rssi_2) }, \
         { "rx_noise_adapter", NULL, MAVLINK_TYPE_INT8_T, 0, 24, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_noise_adapter) }, \
         { "rx_noise_antenna1", NULL, MAVLINK_TYPE_INT8_T, 0, 25, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_noise_antenna1) }, \
         { "rx_noise_antenna2", NULL, MAVLINK_TYPE_INT8_T, 0, 26, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_noise_antenna2) }, \
         { "rx_signal_quality_adapter", NULL, MAVLINK_TYPE_INT8_T, 0, 27, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_signal_quality_adapter) }, \
         { "rx_signal_quality_antenna1", NULL, MAVLINK_TYPE_INT8_T, 0, 28, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_signal_quality_antenna1) }, \
         { "rx_signal_quality_antenna2", NULL, MAVLINK_TYPE_INT8_T, 0, 29, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_signal_quality_antenna2) }, \
         ...
         { "rx_snr_antenna1", NULL, MAVLINK_TYPE_INT8_T, 0, 32, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_snr_antenna1) }, \
         { "rx_snr_antenna2", NULL, MAVLINK_TYPE_INT8_T, 0, 33, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_snr_antenna2) }, \
         { "card_temperature", NULL, MAVLINK_TYPE_INT8_T, 0, 34, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_temperature) }, \
...
static inline uint16_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t card_index, uint8_t card_type, uint8_t tx_active, int8_t rx_rssi, int8_t rx_rssi_1, int8_t rx_rssi_2, int8_t rx_noise_adapter, int8_t rx_noise_antenna1, int8_t rx_noise_antenna2, int8_t rx_signal_quality_adapter, int8_t rx_signal_quality_antenna1, int8_t rx_signal_quality_antenna2, int16_t tx_power_current, int16_t tx_power_armed, int16_t tx_power_disarmed, uint32_t count_p_received, uint32_t count_p_injected, int8_t curr_rx_packet_loss_perc, uint8_t curr_status, int8_t rx_snr_antenna1, int8_t rx_snr_antenna2, int8_t card_temperature, int32_t dummy2)
{
    ...
    _mav_put_uint8_t(buf, 18, card_index);
    _mav_put_uint8_t(buf, 19, card_type);
    _mav_put_uint8_t(buf, 20, tx_active);
    _mav_put_int8_t(buf, 21, rx_rssi);
    _mav_put_int8_t(buf, 22, rx_rssi_1);
    _mav_put_int8_t(buf, 23, rx_rssi_2);
    _mav_put_int8_t(buf, 24, rx_noise_adapter);
    _mav_put_int8_t(buf, 25, rx_noise_antenna1);
    _mav_put_int8_t(buf, 26, rx_noise_antenna2);
    _mav_put_int8_t(buf, 27, rx_signal_quality_adapter);
    _mav_put_int8_t(buf, 28, rx_signal_quality_antenna1);
    _mav_put_int8_t(buf, 29, rx_signal_quality_antenna2);
    _mav_put_int8_t(buf, 30, curr_rx_packet_loss_perc);
    _mav_put_uint8_t(buf, 31, curr_status);
    _mav_put_int8_t(buf, 32, rx_snr_antenna1);
    _mav_put_int8_t(buf, 33, rx_snr_antenna2);
    _mav_put_int8_t(buf, 34, card_temperature);
...
/**
 * @brief Get field rx_snr_antenna1 from openhd_stats_monitor_mode_wifi_card message
 *
 * @return  SNR in dB for antenna1
 */
static inline int8_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_rx_snr_antenna1(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int8_t(msg,  32);
}

/**
 * @brief Get field rx_snr_antenna2 from openhd_stats_monitor_mode_wifi_card message
 *
 * @return  SNR in dB for antenna2
 */
static inline int8_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_rx_snr_antenna2(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int8_t(msg,  33);
}

/**
 * @brief Get field card_temperature from openhd_stats_monitor_mode_wifi_card message
 *
 * @return  Wifi card temperature [degC]
 */
static inline int8_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_card_temperature(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_decode(const mavlink_message_t* msg, mavlink_openhd_stats_monitor_mode_wifi_card_t* openhd_stats_monitor_mode_wifi_card)
{
    ...
    openhd_stats_monitor_mode_wifi_card->rx_snr_antenna1 = mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_rx_snr_antenna1(msg);
    openhd_stats_monitor_mode_wifi_card->rx_snr_antenna2 = mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_rx_snr_antenna2(msg);
    openhd_stats_monitor_mode_wifi_card->card_temperature = mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_card_temperature(msg);
#else
