...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD 1211


typedef struct __mavlink_openhd_stats_monitor_mode_wifi_card_t {
 uint64_t count_p_received; /*<  All received (incoming) packets*/
 uint64_t count_p_injected; /*<  All injected (outgoing) packets*/
...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_LEN 40
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_MIN_LEN 40
#define MAVLINK_MSG_ID_1211_LEN 40
#define MAVLINK_MSG_ID_1211_MIN_LEN 40

#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_CRC 73
#define MAVLINK_MSG_ID_1211_CRC 73
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_CARD { \
    ...
    12, \
    {  { "card_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_index) }, \
         { "card_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 35, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_type) }, \
         { "rx_rssi_1", NULL, MAVLINK_TYPE_INT8_T, 0, 36, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_rssi_1) }, \
         { "rx_rssi_2", NULL, MAVLINK_TYPE_INT8_T, 0, 37, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_rssi_2) }, \
         { "tx_power", NULL, MAVLINK_TYPE_INT16_T, 0, 32, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, tx_power) }, \
         { "count_p_received", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, count_p_received) }, \
         { "count_p_injected", NULL, MAVLINK_TYPE_UINT64_T, 0, 8, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, count_p_injected) }, \
         { "curr_rx_packet_loss_perc", NULL, MAVLINK_TYPE_INT8_T, 0, 38, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, curr_rx_packet_loss_perc) }, \
         { "dummy0", NULL, MAVLINK_TYPE_INT8_T, 0, 39, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy0) }, \
         { "dummy1", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy1) }, \
         { "dummy2", NULL, MAVLINK_TYPE_INT32_T, 0, 28, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy2) }, \
         { "dummy3", NULL, MAVLINK_TYPE_UINT64_T, 0, 16, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy3) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_CARD { \
...
static inline uint16_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t card_index, uint8_t card_type, int8_t rx_rssi_1, int8_t rx_rssi_2, int16_t tx_power, uint64_t count_p_received, uint64_t count_p_injected, int8_t curr_rx_packet_loss_perc, int8_t dummy0, int32_t dummy1, int32_t dummy2, uint64_t dummy3)
{
    ...
    _mav_put_int32_t(buf, 24, dummy1);
    _mav_put_int32_t(buf, 28, dummy2);
    _mav_put_int16_t(buf, 32, tx_power);
    _mav_put_uint8_t(buf, 34, card_index);
    _mav_put_uint8_t(buf, 35, card_type);
    _mav_put_int8_t(buf, 36, rx_rssi_1);
    _mav_put_int8_t(buf, 37, rx_rssi_2);
    _mav_put_int8_t(buf, 38, curr_rx_packet_loss_perc);
...
{
    return mavlink_msg_openhd_stats_monitor_mode_wifi_card_pack(system_id, component_id, msg, openhd_stats_monitor_mode_wifi_card->card_index, openhd_stats_monitor_mode_wifi_card->card_type, openhd_stats_monitor_mode_wifi_card->rx_rssi_1, openhd_stats_monitor_mode_wifi_card->rx_rssi_2, openhd_stats_monitor_mode_wifi_card->tx_power, openhd_stats_monitor_mode_wifi_card->count_p_received, openhd_stats_monitor_mode_wifi_card->count_p_injected, openhd_stats_monitor_mode_wifi_card->curr_rx_packet_loss_perc, openhd_stats_monitor_mode_wifi_card->dummy0, openhd_stats_monitor_mode_wifi_card->dummy1, openhd_stats_monitor_mode_wifi_card->dummy2, openhd_stats_monitor_mode_wifi_card->dummy3);
}
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_send(mavlink_channel_t chan, uint8_t card_index, uint8_t card_type, int8_t rx_rssi_1, int8_t rx_rssi_2, int16_t tx_power, uint64_t count_p_received, uint64_t count_p_injected, int8_t curr_rx_packet_loss_perc, int8_t dummy0, int32_t dummy1, int32_t dummy2, uint64_t dummy3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_LEN];
    _mav_put_uint64_t(buf, 0, count_p_received);
 ...
 */
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t card_index, uint8_t card_type, int8_t rx_rssi_1, int8_t rx_rssi_2, int16_t tx_power, uint64_t count_p_received, uint64_t count_p_injected, int8_t curr_rx_packet_loss_perc, int8_t dummy0, int32_t dummy1, int32_t dummy2, uint64_t dummy3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_count_p_received(const mavlink_message_t* msg)
{
 ...
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_count_p_injected(const mavlink_message_t* msg)
{
 ...
 * @return  for future use
 */
static inline int32_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_dummy1(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field dummy3 from openhd_stats_monitor_mode_wifi_card message
 *
 * @return  for future use
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_dummy3(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_decode(const mavlink_message_t* msg, mavlink_openhd_stats_monitor_mode_wifi_card_t* openhd_stats_monitor_mode_wifi_card)
{
    ...
    openhd_stats_monitor_mode_wifi_card->dummy3 = mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_dummy3(msg);
