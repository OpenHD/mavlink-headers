...
#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_FEC_PERFORMANCE_LEN 24
#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_FEC_PERFORMANCE_MIN_LEN 24
#define MAVLINK_MSG_ID_1217_LEN 24
#define MAVLINK_MSG_ID_1217_MIN_LEN 24

#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_FEC_PERFORMANCE_CRC 196
#define MAVLINK_MSG_ID_1217_CRC 196
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_WB_VIDEO_GROUND_FEC_PERFORMANCE { \
    ...
    8, \
    {  { "link_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_openhd_stats_wb_video_ground_fec_performance_t, link_index) }, \
         ...
         { "dummy0", NULL, MAVLINK_TYPE_INT8_T, 0, 23, offsetof(mavlink_openhd_stats_wb_video_ground_fec_performance_t, dummy0) }, \
         { "dummy1", NULL, MAVLINK_TYPE_INT16_T, 0, 20, offsetof(mavlink_openhd_stats_wb_video_ground_fec_performance_t, dummy1) }, \
         { "dummy2", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_openhd_stats_wb_video_ground_fec_performance_t, dummy2) }, \
         { "dummy3", NULL, MAVLINK_TYPE_UINT32_T, 0, 16, offsetof(mavlink_openhd_stats_wb_video_ground_fec_performance_t, dummy3) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_WB_VIDEO_GROUND_FEC_PERFORMANCE { \
...
static inline uint16_t mavlink_msg_openhd_stats_wb_video_ground_fec_performance_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t link_index, uint32_t curr_fec_decode_time_avg_us, uint32_t curr_fec_decode_time_min_us, uint32_t curr_fec_decode_time_max_us, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
    ...
    _mav_put_int16_t(buf, 20, dummy1);
    _mav_put_uint8_t(buf, 22, link_index);
...
static inline void mavlink_msg_openhd_stats_wb_video_ground_fec_performance_send(mavlink_channel_t chan, uint8_t link_index, uint32_t curr_fec_decode_time_avg_us, uint32_t curr_fec_decode_time_min_us, uint32_t curr_fec_decode_time_max_us, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_FEC_PERFORMANCE_LEN];
    _mav_put_uint32_t(buf, 0, curr_fec_decode_time_avg_us);
...
/**
 * @brief Get field dummy3 from openhd_stats_wb_video_ground_fec_performance message
 *
 * @return  for future use
 */
static inline uint32_t mavlink_msg_openhd_stats_wb_video_ground_fec_performance_get_dummy3(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_openhd_stats_wb_video_ground_fec_performance_decode(const mavlink_message_t* msg, mavlink_openhd_stats_wb_video_ground_fec_performance_t* openhd_stats_wb_video_ground_fec_performance)
{
    ...
    openhd_stats_wb_video_ground_fec_performance->dummy3 = mavlink_msg_openhd_stats_wb_video_ground_fec_performance_get_dummy3(msg);
