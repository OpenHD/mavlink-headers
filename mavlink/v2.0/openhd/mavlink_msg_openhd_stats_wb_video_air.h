...
#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_AIR_CRC 124
#define MAVLINK_MSG_ID_1214_CRC 124
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_WB_VIDEO_AIR { \
    ...
    {  { "link_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_openhd_stats_wb_video_air_t, link_index) }, \
         ...
         { "curr_dropped_packets", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_openhd_stats_wb_video_air_t, curr_dropped_packets) }, \
...
static inline uint16_t mavlink_msg_openhd_stats_wb_video_air_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t link_index, uint8_t curr_video_codec, int16_t curr_recommended_bitrate, int32_t curr_measured_encoder_bitrate, int32_t curr_injected_bitrate, int32_t curr_injected_pps, int32_t curr_dropped_packets, int16_t curr_fec_percentage, int16_t curr_keyframe_interval, uint8_t recording_active, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
    ...
    _mav_put_int32_t(buf, 12, curr_dropped_packets);
 ...
 * @return  for future use
 */
static inline uint32_t mavlink_msg_openhd_stats_wb_video_air_get_dummy3(const mavlink_message_t* msg)
{
