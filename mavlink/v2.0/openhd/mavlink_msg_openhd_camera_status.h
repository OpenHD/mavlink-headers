...
/**
 * @brief Get field dummy0 from openhd_camera_status message
 *
...
/**
 * @brief Get field dummy1 from openhd_camera_status message
 *
 * @return  for future use
 */
static inline int16_t mavlink_msg_openhd_camera_status_get_dummy1(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  12);
}

/**
 * @brief Get field dummy2 from openhd_camera_status message
 *
 * @return  for future use
 */
static inline int32_t mavlink_msg_openhd_camera_status_get_dummy2(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    openhd_camera_status->dummy2 = mavlink_msg_openhd_camera_status_get_dummy2(msg);
    ...
    openhd_camera_status->dummy0 = mavlink_msg_openhd_camera_status_get_dummy0(msg);
#else
