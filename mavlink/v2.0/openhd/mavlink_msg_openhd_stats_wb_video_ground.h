...
#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_LEN 32
#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_MIN_LEN 32
#define MAVLINK_MSG_ID_1216_LEN 32
#define MAVLINK_MSG_ID_1216_MIN_LEN 32

#define MAVLINK_MSG_ID_OPENHD_STATS_WB_VIDEO_GROUND_CRC 54
#define MAVLINK_MSG_ID_1216_CRC 54
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_WB_VIDEO_GROUND { \
    ...
    10, \
    {  { "link_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 30, offsetof(mavlink_openhd_stats_wb_video_ground_t, link_index) }, \
         ...
         { "dummy0", NULL, MAVLINK_TYPE_INT8_T, 0, 31, offsetof(mavlink_openhd_stats_wb_video_ground_t, dummy0) }, \
         { "dummy1", NULL, MAVLINK_TYPE_INT16_T, 0, 28, offsetof(mavlink_openhd_stats_wb_video_ground_t, dummy1) }, \
         { "dummy2", NULL, MAVLINK_TYPE_INT32_T, 0, 20, offsetof(mavlink_openhd_stats_wb_video_ground_t, dummy2) }, \
         { "dummy3", NULL, MAVLINK_TYPE_UINT32_T, 0, 24, offsetof(mavlink_openhd_stats_wb_video_ground_t, dummy3) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_WB_VIDEO_GROUND { \
...
static inline uint16_t mavlink_msg_openhd_stats_wb_video_ground_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t link_index, int32_t curr_incoming_bitrate, uint32_t count_blocks_total, uint32_t count_blocks_lost, uint32_t count_blocks_recovered, uint32_t count_fragments_recovered, int8_t dummy0, int16_t dummy1, int32_t dummy2, uint32_t dummy3)
{
    ...
    _mav_put_uint32_t(buf, 24, dummy3);
 ...
 * @return  for future use
 */
static inline uint32_t mavlink_msg_openhd_stats_wb_video_ground_get_dummy3(const mavlink_message_t* msg)
{
